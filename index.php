<?php //Php location start echo "PHP active \n";?>
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
  ...
  <body text="#cccccc" link="#00cc00" vlink="#999999" alink="#ff0000" bgcolor="#000000" background="./i/creations/digitalcentipede.jpg">
    <div style="margin-left:auto;margin-right:auto;width:100%;text-align:center;" class="subtitle"> 
      Reality Biproducts, Version 5.9.8:<!-- Page Update TESTTESTTESTTEST, also get a counter that will input here. -->
      <br />
      <u>Thinking about things, so you don't have to.</u><br /><p></p>
    </div>

    <div style="width:33%;text-align:left:position:relative;float:left;background-image:url('./i/orange-storm-corner.jpg');background-repeat:no-repeat;" class="left"><!-- LEFT-->
    ...
    <div style="width:33%;text-align:center;position:relative;float:left;background-image:url('./i/orange-storm-corner.jpg');background-repeat:no-repeat;" class="core"><!-- CORE-->
      <div class="title">
    ...
    <div style="position:relative;width:33%;text-align:right;float:left;background-image:url('./i/orange-storm-corner.jpg');background-repeat:no-repeat;" class="right"><!-- RIGHT-->
      ...
      <a class="fade" href="mailto:tchalvak@gmail.com">tchalvak@</a><br />
      <b>AIM: Tchalvak</b><br/>
      <a href="#conceptart" onclick="window.open('http://conceptart.org/forums/','Conceptart','');">Conceptart.org</a>
    </div>

    <div style="margin-left:auto;margin-right:auto;width:100%;text-align:center" class="bottom"><!-- BOTTOM-->
