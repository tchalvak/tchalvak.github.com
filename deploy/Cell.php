...
/*
*	The cell is the php saved version of the JavaCell object.
*/
class Cell
{	
	private $m_id; 	// int.
	...
	public function display()
	{
		...
		echo 
			"
			<a href='".$link."'>
				<div style='float:right;min-width:".$width.' '.$unitType.";min-height:".$height.' '.$unitType.";background-image:url(".$imagePath.")' id='cell".$id."'>
					".(isset($name)? $name : '&nbsp;')."
				</div>
			</a>";
